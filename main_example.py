...
def main():
    ...
    ctrl_pts = []
    ctrl_pts.append(ControlPoint(np.array([0, 0]), np.array([1/3, 0.])))
    ctrl_pts.append(ControlPoint(np.array([1, 0]), np.array([2/3, 0.])))
    ctrl_pts.append(ControlPoint(np.array([1, 0]), np.array([1+1/3, 0.])))
    ctrl_pts.append(ControlPoint(np.array([2, 0]), np.array([1+2/3, 0.])))
    ctrl_pts.append(ControlPoint(np.array([2, 0]), np.array([2+1/3, 0.])))
    ctrl_pts.append(ControlPoint(np.array([3, 0]), np.array([2+2/3., 0.])))
